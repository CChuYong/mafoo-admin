...
const FormLayouts = () => {
  ...
  useEffect(() => {
   // const actualQuery = queryOptions
    ...
    instance
      .get(`/photo/v1/admin/photos?page=${paginationModel.page}&size=${paginationModel.pageSize}${queryParam}`)
      .then((res) => {
        const data = res.data
  ...
  const columns: GridColDef<any>[] = [
    {field: 'photoId', headerName: '사진 ID', width: 240},
    {
      field: 'photoUrl',
      headerName: '사진 URL',
      width: 360,
